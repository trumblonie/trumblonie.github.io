...
/////////////////////////////////////////////////
	...
	$mail->From = "info@no-reply.com";
	$mail->FromName = "Congratulations!";
	$mail->AddAddress("dxhans5@gmail.com", "Donny Hansen");
	$mail->AddReplyTo("no-reply@somesite.com", "Form Submission");
	$mail->WordWrap = 50;    // set word wrap

	$mail->IsHTML(true);    // set email format to HTML
	$mail->Subject = "There has been a new supporter added!";
	
	$body  = "<h1>SUPPORTER SUBMISSION</h1>";
	$body .= "Congratulations!<br/><br>";
	$body .= "Name: " . $first_name . " " . $last_name . "<br/>";
	$body .= "Affiliation: " . $affiliation . "<br/>";
	$body .= "Email: " . $email . "<br/>";
	$body .= "Phone: " . $phone . "<br/>";
